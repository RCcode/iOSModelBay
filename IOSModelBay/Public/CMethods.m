...
//{
////    mutableArray = array;
//    [[DataUtil defaultDateUtil].appsArray removeAllObjects];
//    [DataUtil defaultDateUtil].appsArray = [[NSMutableArray alloc] init];
...
//    for (ME_AppInfo *appInfo in array)
//    {
...
//        }
//    }
//    [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithInteger:un_down_datasource.count] forKey:@"uoDownCount"];
//    [[DataUtil defaultDateUtil].appsArray addObjectsFromArray:un_down_datasource];
//    [[DataUtil defaultDateUtil].appsArray addObjectsFromArray:have_down_datasource];
//}
